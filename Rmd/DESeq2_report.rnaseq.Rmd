...
params:
  ...
  group_filter:  "TMPP" # !r NA  Which group will this report be done on?
...
if (Platform == "TempO-Seq") {
  genes <- biospyder[biospyder$PROBE_NAME %in% genes,] %>% pull(ENSEMBL_GENE_ID)
  ...
  id_table_entrez <- id_table_entrez %>%
    dplyr::left_join(biospyder, by = c("ensembl_gene_id" = "ENSEMBL_GENE_ID"))
  id_table <- id_table_entrez[, c(8,1:3)] # Manageable subset of the annotations
} else {
