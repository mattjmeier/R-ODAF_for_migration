...
params:
  ...
  group_filter:  "0 hr"# !r NA # Optional. Only look at a particular group within a facet.
...
if (species == "human") {
  ...
  wiki <- "wikipathways-20210810-gmt-Homo_sapiens.gmt"
  ...
  if (species == "mouse") {
    ...
    wiki <- "wikipathways-20210810-gmt-Mus_musculus.gmt"
  ...
  if (species == "rat") {
    ...
    wiki <- "wikipathways-20210810-gmt-Rattus_norvegicus.gmt"
